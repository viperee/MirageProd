        ...
        <div id="tabs-container" class="background-solitude">
                ...
                <div class="block-accordeon mb-4 container background-white">
                    ...
                    <div class="content-accordeon pb-5">
                        ...
                        <p class="texte-accordeon">Transport Handicap s’engage pour l’accès à la culture des personnes handicapées. A cet effet, il propose un service de transport avec des véhicules adaptés aux personnes à mobilité réduite, à tarif préférentiel (entre 20 et 40 euros, aller et retour, selon la distance).<br><br>
                            Cette offre est limitée au canton à Bordeaux et uniquement sur réservation, au moins 24h à l’avance. Elle ne comprend pas le billet d’entrée au festival, qui doit être acheté séparément.</p>
                    </div>
                </div>
                <div class="block-accordeon mb-4 container background-white">
                    <div class="row">
            ...
            <div id="tabs-hebergement" class="container-fluid">
                ...
                <div class="block-accordeon mb-4 container background-white">
                    ...
                    <div class="content-accordeon pb-5">
                        <p class="texte-accordeon">Pour vous renseigner sur les possibilités de logement de la région, consultez les sites suivants :<br><br><a class="liens-habitants" href="https://www.airbnb.fr/" target="_blank">Airbnb</a><br><a class="liens-habitants" href="https://www.booking.com" target="_blank">Booking</a></p>
                    </div>
                </div>
            </div>
        </div>
